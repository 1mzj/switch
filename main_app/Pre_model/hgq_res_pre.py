...
if 'dist' in current_path:
    ...
    model_path = os.path.join(app01_path, "Pre_model/hgq/", "cnn_model.pth")
    scaler_X_path = os.path.join(app01_path, "Pre_model/hgq/", 'scaler_X.pkl')
    scaler_y_path = os.path.join(app01_path, "Pre_model/hgq/", 'scaler_y.pkl')
else:
    model_path = os.path.join("main_app/Pre_model/hgq/", "cnn_model.pth")
    scaler_X_path = os.path.join("main_app/Pre_model/hgq/", 'scaler_X.pkl')
    scaler_y_path = os.path.join("main_app/Pre_model/hgq/", 'scaler_y.pkl')
