...
if 'dist' in current_path:
    ...
    model_path = os.path.join(app01_path, "Pre_model/jxb/", "cnn_model_tep.pth")
    scaler_X_path = os.path.join(app01_path, "Pre_model/jxb/", 'scaler_X_tep.pkl')
    scaler_y_path = os.path.join(app01_path, "Pre_model/jxb/", 'scaler_y_tep.pkl')
else:
    model_path = os.path.join("main_app/Pre_model/jxb/", "cnn_model_tep.pth")
    scaler_X_path = os.path.join("main_app/Pre_model/jxb/", 'scaler_X_tep.pkl')
    scaler_y_path = os.path.join("main_app/Pre_model/jxb/", 'scaler_y_tep.pkl')
...
# 预测函数
def predict_jiexianban_tep(data):
    """
    预测隔离开关温度
